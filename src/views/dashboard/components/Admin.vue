...
@font-face {
  ...
  src:
    url("https://cdn.jsdelivr.net/gh/webfontworld/TheJamsil/TheJamsil-Light.eot?#iefix") format("embedded-opentype"),
...
@font-face {
  ...
  src:
    url("https://cdn.jsdelivr.net/gh/webfontworld/TheJamsil/TheJamsil-Regular.eot?#iefix") format("embedded-opentype"),
...
<template>
  <main id="main" class="main">
    <section class="section dashboard">
      <div class="row">
        <div class="col-lg-12" style="margin-bottom: 1vw; padding: 2vw">
          <!-- ======= Hero Section ======= -->
          <section id="hero" class="hero d-flex align-items-center section-bg">
            <div class="container">
              <div class="row justify-content-between gy-5">
                ...
                >
                  <h1 data-aos="fade-up" class="TheJamsil400" style="white-space: nowrap; margin: 1vw">
            ...
            <div class="col-12">
              ...
              <div class="col-12">
                <div class="card recent-sales overflow-auto">
                  <div class="filter">
                    <a class="icon" href="#" data-bs-toggle="dropdown"><i class="bi bi-three-dots" /></a>
